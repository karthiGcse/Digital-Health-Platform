    ...
    const response = await fetch("https://ai.gateway.lovable.dev/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are S47 Health AI, a knowledgeable medical assistant. You provide helpful health guidance while always recommending professional consultation for serious concerns.

Guidelines:
- Give clear, evidence-based health information
